...
website issues (generated by clustering) during runtime. They are displayed by
the website_issues app (sites/ url).
To load example site data without getting it pushed from metrics, run 

    ./manage.py dbshell --database=website_issues \
        < lib/website_issues/clusters.sql
